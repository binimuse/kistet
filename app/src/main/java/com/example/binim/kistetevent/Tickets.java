...
public class Tickets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setSpaceOnClickListener(new SpaceOnClickListener() {
            ...
            public void onCentreButtonClick() {
                ...
                Intent i = new Intent(Tickets.this, Home.class);
                startActivity(i);
            }

            @Override
            public void onItemClick(int itemIndex, String itemName) {
                Toast.makeText(Tickets.this, itemIndex + " " + itemName, Toast.LENGTH_SHORT).show();


                if (itemIndex == 0) {
                    Intent ii = new Intent(Tickets.this, Search.class);
                ...
                {
                    Intent ii = new Intent (Tickets.this,Tickets.class);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    startActivity(ii);
                }else if (itemIndex == 2) {
                    Intent ii = new Intent(Tickets.this, Likes.class);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    startActivity(ii);
                } else if (itemIndex == 3) {
                    Intent ii = new Intent(Tickets.this, Setting.class);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    ii.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    startActivity(ii);
        ...
        navigationView.setSpaceOnLongClickListener(new SpaceOnLongClickListener() {
            ...
            public void onCentreButtonLongClick() {
                Toast.makeText(Tickets.this, "onCentreButtonLongClick", Toast.LENGTH_SHORT).show();
    ...
    public void Onserch(View view) {
        Intent i = new Intent (Tickets.this,SearchEvet.class);
        startActivity(i);
